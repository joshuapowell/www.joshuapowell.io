...
"""Command Line Interface for Viable Data.

Created by Viable Industries, L.L.C. on 10/30/2017.
...
class ApplicationCLI(object):
    ...
    def __init__(self, parser=None, args=None):
        ...
        self.parser = argparse.ArgumentParser(**{
            'prog': 'Viable Data',
            'description': 'Static IV, the Viable static site generator'
        })

        self.parser.add_argument('--environment', **{
            'type': str,
            'help': 'set application environment (default: default)',
            'default': 'default'
        })
